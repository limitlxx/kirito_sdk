...
exports.testGIFCreation = testGIFCreation;
...
async function testGIFCreation() {
    ...
    try {
        ...
        const gifPath = (0, path_1.join)(outputDir, 'test-animated.gif');
        (0, fs_1.writeFileSync)(gifPath, gifBuffer);
        ...
        for (const [name, buffer] of Object.entries(variantResults)) {
            ...
            const variantPath = (0, path_1.join)(outputDir, `test-${name}.${ext}`);
            (0, fs_1.writeFileSync)(variantPath, buffer);
...
//# sourceMappingURL=test-gif-creation.js.map